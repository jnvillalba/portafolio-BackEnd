...
import com.porfolio.jnv.Dto.dtoEducacion;
import com.porfolio.jnv.Entity.Educacion;
import com.porfolio.jnv.Security.Controller.Mensaje;
import com.porfolio.jnv.Service.EducacionService;
...
public class EducacionController {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getTitulo(),
                dtoeducacion.getPeriodo(),dtoeducacion.getImg()
            );
